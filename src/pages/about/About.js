      ...
      <main>
        <section className="section" style={{ gridTemplateColumns: '1fr' }}>
          <div>
            ...
            <p className="para">
              DevCard is the go-to platform for developers to create
              professional business cards that showcase their skills and
              expertise. Our user-friendly platform allows you to get cards that
              reflect your brand and communicate your value proposition. Join us
              today to elevate your professional image and succeed in your
              career!
            </p>
            <p className="para">
          ...
          <div>
            ...
            <p className="para">
              ...
              exceptional business cards are designed to elevate your profile
              and differentiate you from your competitors.
            </p>
            <p className="para">
              As a developer, your skills and expertise are vital to your
              success, and our high-quality cards are tailored to showcase them.
              With a focus on quality, our cards are crafted using premium
              materials and modern designs that exude professionalism and
              sophistication. Whether you&lsquo;re networking at a conference or
              meeting a potential client, our cards will make a lasting
              impression and communicate your brand&lsquo;s value.
            </p>
          </div>
        </section>
        ...
        <section className="cards">
          <div>
            ...
            <p className="para">
              ...
              credits, you can use those credits to get your favorite card.
